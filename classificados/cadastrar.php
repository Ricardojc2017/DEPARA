...
<html lang="pt_BR">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="DataTable/dataTables.css"/>
        <link rel="stylesheet" type="text/css" href="css/twitter-typeahead.css" />
...
<!--    <form id="formCadastrar" method="post" action="xt_cadastrar.php">-->
...
?>
    ...
    <tr>  
        <td name="source">
           ...
           <input id="typeaheadS" name=source[] type="hidden" value="<?php echo $linha["de"];?>"> 
        ...
        <td style="text-align:center;"> 
            <?php if ($linha["status"] != "existe"):  ?>
              ...
              <input  id="typeahead" name=destination[] class="typeahead"  type="text" size="75"  placeholder=" " > 
    ...
    <?php endforeach; ?>
     ...
     <div align="center" >
       ...
       <!-- <button id="btnCadastrar" type="submit" class="btn btn-secondary"  value="Reload" > Enviar</button>-->
        
        <!-- <button id="btnCadastrar" type="submit" onclick="executar()"  id="btnEnviarDados"  class="btn btn-secondary" >Enviar</button> -->
       
       
        <input  id="btnCadastrar" class="btn btn-secondary" type="submit"  class="btn btn-secondary"  onClick="document.location.reload(true)"  value="Enviar">
...
var procura = "";
   ...
   //var campo = document.getElementById('typeahead');

  //form.addEventListener('submit', function(e) {
    // alerta o valor do campo   //form.value
...
// valor.onclick = function() {     
  ...
  // var texto = document.getElementById('typeahead').value; 
...
//var form = document.getElementById('formCadastrar'); //id do form
//var valor = document.getElementById('btnCadastrar'); //id do botão

/*valor.onclick = function() { 

var texto = document.getElementById('typeahead').value; //id do destination
 ...
 var form = document.getElementById('formCadastrar');
   ...
   if(form != '' ) {
	...
	$('input#btnCadastrar').bind('click', function() {     
          ...
          //$('div#resultado').html("Dados Gravados com Sucesso!");  
         //console.log(form);
        // alert('salvo com sucesso !!');                
